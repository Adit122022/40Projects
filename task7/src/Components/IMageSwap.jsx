...
const IMageSwap = () => {
  ...
  return (
    <div className="flex md:flex-row flex-col justify-center gap-5 items-center w-screen h-screen py-5 px-10 bg-gray-500">
     <div className='rounded-lg shadow-lg md:w-3/12 h-2/3 overflow-hidden border-2 border-gray-300'>
     <img
      ref={img1Ref}
